...
mkdir Vehicle_Detection_Dataset/annotations
mkdir Vehicle_Detection_Dataset/annotations/train
mkdir Vehicle_Detection_Dataset/annotations/val
...
mv -v kitti_train_yolov5_annotations/* Vehicle_Detection_Dataset/annotations/train
mv -v kitti_val_yolov5_annotations/* Vehicle_Detection_Dataset/annotations/val
...
mv -v coco_train_yolov5_annotations/* Vehicle_Detection_Dataset/annotations/train
mv -v coco_val_yolov5_annotations/* Vehicle_Detection_Dataset/annotations/val
...
mv -v gtav_train_yolov5_annotations/* Vehicle_Detection_Dataset/annotations/train
mv -v gtav_val_yolov5_annotations/* Vehicle_Detection_Dataset/annotations/val
